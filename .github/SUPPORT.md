# Hỗ Trợ Kỹ Thuật (Seeking Support)

Chúng tôi chỉ sử dụng bảng theo dõi lỗi (issue tracker) trên GitHub cho các báo cáo lỗi hệ thống (bug reports) và yêu cầu tính năng mới (feature requests). Chúng tôi không hỗ trợ các câu hỏi thảo luận chung hoặc hỗ trợ cài đặt thông qua GitHub Issues.
